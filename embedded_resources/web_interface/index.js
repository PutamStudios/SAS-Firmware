  ...
  fileList
    ...
    .forEach((line) => {
      ...
      if (type === "pa") {
        ...
        if (IS_DEV) downloadUrl = "/sas" + downloadUrl;
...
async function fetchSystemInfo() {
  ...
  $(".sas-version").textContent = info.SAS_VERSION;
...
async function reloadScreen() {
  ...
  try {
    let binResponse = await fetch((IS_DEV ? "/sas" : "") + "/getscreen");
