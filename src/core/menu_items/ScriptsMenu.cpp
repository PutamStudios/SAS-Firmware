...
void ScriptsMenu::drawIcon(float scale) {
    ...
    // File
    tft.drawRect(iconCenterX - iconW / 2, iconCenterY - iconH / 2, iconW, iconH, sasConfig.priColor);
    tft.fillRect(
        iconCenterX + iconW / 2 - foldSize, iconCenterY - iconH / 2, foldSize, foldSize, sasConfig.bgColor
    );
    tft.drawTriangle(
