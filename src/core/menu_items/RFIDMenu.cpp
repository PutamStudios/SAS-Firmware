...
void RFIDMenu::optionsMenu() {
...
#ifndef LITE_VERSION
    if (sasConfigPins.rfidModule == PN532_I2C_MODULE) {
    ...
    String txt = "RFID";
    if (sasConfigPins.rfidModule == M5_RFID2_MODULE) txt += " (RFID2)";
#ifdef M5STICK
    else if (sasConfigPins.rfidModule == PN532_I2C_MODULE) txt += " (PN532-G33)";
    else if (sasConfigPins.rfidModule == PN532_I2C_SPI_MODULE) txt += " (PN532-G36)";
#else
    else if (sasConfigPins.rfidModule == PN532_I2C_MODULE) txt += " (PN532-I2C)";
#endif
    else if (sasConfigPins.rfidModule == PN532_SPI_MODULE) txt += " (PN532-SPI)";
    else if (sasConfigPins.rfidModule == RC522_SPI_MODULE) txt += " (RC522-SPI)";
...
void RFIDMenu::drawIcon(float scale) {
    ...
    tft.fillRect(iconCenterX - iconSize / 2, iconCenterY, iconSize / 2, iconSize / 2, sasConfig.bgColor);
