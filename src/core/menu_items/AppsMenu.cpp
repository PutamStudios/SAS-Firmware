...
void AppsMenu::drawIcon(float scale) {
    ...
    tft.drawRoundRect(startX, startY, size, size, 2, sasConfig.priColor);
    tft.drawRoundRect(startX + size + gap, startY, size, size, 2, sasConfig.priColor);
    tft.drawRoundRect(startX, startY + size + gap, size, size, 2, sasConfig.priColor);
    tft.drawRoundRect(startX + size + gap, startY + size + gap, size, size, 2, sasConfig.priColor);
}
