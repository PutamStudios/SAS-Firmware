 ...
 * This class is used internally by SASConfig
 * External code should use SASConfig.mifareKeys directly
 */
class MifareKeysManager {
public:
    // Constants
    static constexpr const char *KEYS_PATH = "/SASRFID/keys.conf";
    static constexpr const char *KEYS_DIR = "/SASRFID";
