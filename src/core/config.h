...
class SASConfig : public SASTheme {
public:
    ...
    // Wifi
    Credential webUI = {"admin", "sas"};
    std::vector<String> webUISessions = {}; // FIFO queue of session tokens
    WiFiCredential wifiAp = {"SASNet", "sasnet"};
    ...
    std::vector<QrCodeEntry> qrCodes = {
        {"SAS AP",   "WIFI:T:WPA;S:SASNet;P:sasnet;;"},
        {"SAS Wiki", "https://github.com/pr3y/SAS/wiki"},
        {"SAS Site", "https://sas.computer"            },
