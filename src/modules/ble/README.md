...
BLE Suite is a comprehensive Bluetooth Low Energy security testing framework for ESP32 devices running SAS firmware. Provides reconnaissance, protocol exploitation, and post-exploitation capabilities.
