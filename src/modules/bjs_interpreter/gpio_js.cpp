...
JSValue native_pins(JSContext *ctx, JSValue *this_val, int argc, JSValue *argv) {
    ...
    JS_SetPropertyStr(ctx, obj, "grove_sda", JS_NewInt32(ctx, sasConfigPins.i2c_bus.sda));
    JS_SetPropertyStr(ctx, obj, "grove_scl", JS_NewInt32(ctx, sasConfigPins.i2c_bus.scl));
    JS_SetPropertyStr(ctx, obj, "serial_tx", JS_NewInt32(ctx, sasConfigPins.uart_bus.tx));
    JS_SetPropertyStr(ctx, obj, "serial_rx", JS_NewInt32(ctx, sasConfigPins.uart_bus.rx));
