...
static const uint32_t __attribute((aligned(64))) js_stdlib_table[] = {
  ...
  0x6c65646f,
  0x00000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (15 << (JS_MTAG_BITS + 3)), /* "getSASVersion" (offset=917) */
  0x42746567,
  0x65637572,
  0x73726556,
  0x006e6f69,
  ...
  JS_ROM_VALUE(917), /* getSASVersion */
