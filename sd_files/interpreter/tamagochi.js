// created by hxd57. V2
// repository: https://github.com/HawkstoNGriM/m5-sas-tamagochi-lite
...
function loadPet() {
  ...
  if (data) {
    try {
      ...
      display.fill(currentBgColor);
      dialog.error("Failed to load pet data: " + e.message);
      return null;
    }
  }
...
while (true) {
  ...
  if (keyboard.getNextPress()) {
    ...
    if (choice === "settings") {
      ...
      if (confirm === "yes") {
        serialCmd("storage remove JS-scripts/sas_0.sub");
